...
awful.screen.connect_for_each_screen(function(s)
	...
	awful.tag({ "Code", "Browser", "Coms" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
	...
	awful.key({ altkey }, "e", function() awful.spawn(fileBrowser) end,
		{ description = "open fire browser", group = "launcher" }),
	awful.key({ altkey }, "b", function() awful.spawn(webBrowser) end,
		{ description = "open web browser", group = "launcher" }),
	awful.key({ altkey }, "c", function() awful.spawn(editor) end,
	...
	-- Prompt
	awful.key({ altkey }, "r", function() awful.spawn(runPrompt) end,
		{ description = "run prompt", group = "launcher" }),

	-- Menubar
	awful.key({}, superkey, function() menubar.show() end,
...
clientkeys = gears.table.join(
	...
	awful.key({ altkey }, "F4", function(c) c:kill() end,
		{ description = "close", group = "client" }),
	awful.key({ altkey }, "w", awful.client.floating.toggle,
		{ description = "toggle floating", group = "client" }),
	awful.key({ altkey }, "s", function(c) c:move_to_screen() end,
